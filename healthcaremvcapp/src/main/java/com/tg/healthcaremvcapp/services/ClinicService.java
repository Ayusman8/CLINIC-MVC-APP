...
import com.tg.healthcaremvcapp.repository.ClinicRepository;
...
@Service
public class ClinicService implements ClinicImplService{
	 ...
	 * cb.equal(root.get("businessName"), businessName);
	 * 
	 * Predicate finalPredicate = cb.and(predicateForClinicName,
	 * predicateForBusinessName);
	 * 
	 * // cq.where(cb.equal(root.get("clinicName"), clinicName));
